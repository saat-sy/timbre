...
export default function HomePage() {
  return (
    ...
    >
      ...
      <main className="relative">
        ...
        <div className="relative z-10 px-6 pt-32 pb-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto animate-fade-in-up animation-delay-200"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: 'var(--text-secondary)' }}
            >
              Our AI understands your video content and creates music that
              perfectly matches the mood, pace, and style you need.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                Advanced AI analyzes your video content to generate music that
                perfectly matches the mood and pacing.
              </p>
            </LiquidGlassCard>
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                Music automatically syncs with your video's rhythm, cuts, and
                emotional beats for seamless integration.
              </p>
            </LiquidGlassCard>
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                Generate professional-quality music in minutes, not hours.
                Perfect for creators on tight deadlines.
              </p>
            </LiquidGlassCard>
          </div>
        </div>
      ...
      <section
        id="how-it-works"
        className="relative px-6 py-20 bg-gradient-to-b from-transparent to-black/20"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <p
              ...
              style={{ color: 'var(--text-secondary)' }}
            >
              Three simple steps to transform your videos with AI-generated
              music
            </p>
          </div>
            ...
            <div className="text-center group">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: 'var(--text-secondary)' }}
                >
                  Simply drag and drop your video file or browse to select it
                  from your device.
                </p>
              </LiquidGlassCard>
            ...
            <div className="text-center group relative">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: 'var(--text-secondary)' }}
                >
                  Tell our AI what kind of music you want - genre, mood,
                  instruments, or any creative direction.
                </p>
              </LiquidGlassCard>
              ...
              <div className="hidden md:block absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2">
                <svg
                  className="w-8 h-8 text-gray-600 animate-pulse animation-delay-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="text-center group">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: 'var(--text-secondary)' }}
                >
                  Download your video with perfectly synchronized AI-generated
                  music in minutes.
                </p>
              </LiquidGlassCard>
            </div>
