...
export function VideoUploadForm({ onSubmit, isLoading }: SimpleVideoUploadProps) {
                  ...
                  <div className="flex justify-center">
                    <div className="relative max-w-2xl w-full aspect-video rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10 group-hover:ring-white/20 transition-all">
                      <img
                        src={videoThumbnail}
                        alt="Video thumbnail"
                        className={`w-full h-full object-cover transition-all duration-700 ${(isProcessing || isLoading) ? 'scale-105' : 'group-hover:scale-105'}`}
                      />
                      ...
                      {(isProcessing || isLoading) && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm">
                          <div className="relative w-24 h-24 mb-6">
                            ...
                            {/* Spinning ring */}
                            <div className="absolute inset-0 border-4 border-transparent border-t-white/80 border-r-white/40 rounded-full animate-spin"></div>
                          ...
                          <div className="relative h-8 overflow-hidden">
                            <span
                              ...
                              className="block text-lg font-light text-white tracking-wide animate-in fade-in slide-in-from-bottom-2 duration-500"
                            >
