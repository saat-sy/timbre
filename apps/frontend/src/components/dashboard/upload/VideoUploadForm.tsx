                                ...
                                <div className="relative group max-w-sm w-full">
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-xl px-5 py-3.5 shadow-xl">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <span className="text-white text-sm font-medium">Generating music</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/60 to-transparent rounded-b-2xl p-3 pt-8">
                                        <div className="flex items-center space-x-2.5">
                                            <div className={`w-7 h-7 rounded-md flex items-center justify-center flex-shrink-0 transition-all duration-200 ${validationError
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className={`text-sm font-medium truncate transition-colors ${validationError ? 'text-red-300' : 'text-white'}`}>
                                                    {selectedFile.name}
                                                </div>
                    ...
                    <div className="relative bg-white/[0.03] rounded-b-lg border-t border-white/5 transition-all duration-300 group-focus-within/textarea:border-white/20 group-focus-within/textarea:bg-white/[0.05]">
                        <div className="px-5 pt-4 pb-3">
                            <textarea
                                ...
                                className={`w-full h-28 px-0 py-0 bg-transparent border-0 text-white placeholder-gray-500 focus:outline-none resize-none text-base leading-relaxed transition-colors ${validationError ? 'text-red-300 placeholder-red-400/50' : ''
                                    }`}
                                disabled={isProcessing}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between px-5 pb-4 pt-2 border-t border-white/5">
                            <div className="flex items-center space-x-3">
                                <div className={`text-xs font-medium transition-colors ${prompt.length > 900
                                    ? 'text-orange-400'
                                    : prompt.length > 0
                                        ? 'text-gray-400'
                                        : 'text-gray-600'
                            ...
                            <button
                                ...
                                className={`group relative h-10 px-6 rounded-full font-medium text-sm transition-all duration-200 overflow-hidden ${isReady && !isProcessing
